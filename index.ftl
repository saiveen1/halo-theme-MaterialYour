            ...
            <div class="welcome">
                ...
                <div class="welcome_contact">
                    ...
                    <a href="${settings.github!}" target="_blank">
                        <i class="mdui-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" class="svg-icon" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                    ...
                    <a href="mailto:${settings.email!}" target="_blank">
                        <i class="mdui-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" class="svg-icon" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                    ...
                    <a data-fancybox="gallery" data-src="${settings.wechat}">
                        <i class="mdui-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" class="svg-icon" preserveAspectRatio="xMidYMid meet" viewBox="0 0 48 48">
